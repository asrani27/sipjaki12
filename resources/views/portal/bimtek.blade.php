...
@section('title', 'Bimtek - SIPJAKI')

@section('content')
<h1 class="text-3xl font-bold text-gray-800 mb-6">Bimtek</h1>
<div class="bg-gradient-to-r from-blue-50 to-indigo-100 rounded-lg shadow-md p-8">
    ...
    <div class="text-center py-12">
        ...
        <h3 class="text-xl font-semibold text-gray-600 mb-2">Belum ada bimtek</h3>
        <p class="text-gray-500">Informasi bimtek akan segera ditampilkan di halaman ini.</p>
    </div>
    @endif
</div>

<!-- Modal Detail Bimtek -->
<div id="bimtekModal" class="fixed inset-0 bg-opacity-50 backdrop-blur-sm hidden items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div class="bg-blue-600 text-white px-6 py-4 rounded-t-lg flex justify-between items-center">
            <h2 class="text-2xl font-bold">Detail Bimtek</h2>
...
<script>
    // Store bimtek data in JavaScript
    const bimtekData = {
        @foreach($bimtek as $item)
        {{ $item->id }}: {
            nama: "{{ $item->nama }}",
    ...
    function openModal(id) {
        ...
        modalContent.innerHTML = `
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-3">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Nama Bimtek</label>
        ...
        const modal = document.getElementById('bimtekModal');
    ...
    document.getElementById('bimtekModal').addEventListener('click', function(e) {
        if (e.target === this) {
            closeModal();
        }
    });
