...
@section('title', 'Tertib Penyelenggara - SIPJAKI')

@section('content')
<div class="bg-white rounded-lg shadow-md p-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Tertib Penyelenggara</h1>

    @if($tertibPenyelenggara->isEmpty())
    <div class="text-center py-12">
        <p class="text-gray-500">Belum ada data Tertib Penyelenggara.</p>
    </div>
    @else
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white">
            ...
            <tbody class="divide-y divide-gray-200">
                @foreach($tertibPenyelenggara as $index => $item)
...
<div id="detailModal"
    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div class="sticky top-0 bg-white border-b px-6 py-4 flex justify-between items-center">
            <h3 class="text-lg font-semibold text-gray-900">Detail Tertib Penyelenggara</h3>
