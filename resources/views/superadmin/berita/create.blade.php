...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 ml-8">Buat konten berita baru untuk website SIPJAKI</p>
    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <label for="gambar" class="cursor-pointer text-center">
                                    <div class="text-gray-500">
                                        ...
                                        <p class="text-sm">Klik untuk mengunggah gambar</p>
                                        <p class="text-xs text-gray-400 mt-1">Maksimal 2MB. Format: JPEG, PNG, JPG, GIF
                                        </p>
                                    </div>
                                </label>
                            </div>
                            ...
                            @if(old('gambar'))
                            <div class="mt-3">
                                <p class="text-sm text-gray-600 mb-2">Gambar yang diunggah:</p>
                                <img src="{{ asset('gambar/' . old('gambar')) }}" alt="Preview"
                        ...
                        <div class="bg-gray-50 rounded-lg">
                            <div class="px-4 py-3 border-b border-gray-200">
                                <h6 class="text-sm font-medium text-gray-900">Preview Gambar</h6>
                            </div>
