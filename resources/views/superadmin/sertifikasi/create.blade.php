...
<div class="p-6">
    <!-- Page Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-2">Tambah Sertifikasi</h1>
        <p class="text-gray-600">Tambahkan data sertifikasi baru</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="p-6">
            <form method="POST" action="{{ route('superadmin.sertifikasi.store') }}">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="tahun" id="tahun"
                            ...
                            value="{{ old('tahun') }}" placeholder="Masukkan tahun sertifikasi" required>
                        @error('tahun')
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" id="nama"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('nama') }}" placeholder="Masukkan nama sertifikasi" required>
                        @error('nama')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="kualifikasi" id="kualifikasi"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('kualifikasi') }}" placeholder="Masukkan kualifikasi" required>
                        @error('kualifikasi')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="klasifikasi" id="klasifikasi"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('klasifikasi') }}" placeholder="Masukkan klasifikasi" required>
                        @error('klasifikasi')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="jam" id="jam"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('jam') }}" placeholder="Contoh: 09:00 - 16:00" required>
                        @error('jam')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="metode" id="metode"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('metode') }}" placeholder="Contoh: Online, Offline" required>
                        @error('metode')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="lokasi" id="lokasi"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('lokasi') }}" placeholder="Masukkan lokasi sertifikasi" required>
                        @error('lokasi')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="sumber_dana" id="sumber_dana"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('sumber_dana') }}" placeholder="Masukkan sumber dana" required>
                        @error('sumber_dana')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="penanggung_jawab" id="penanggung_jawab"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('penanggung_jawab') }}" placeholder="Masukkan nama penanggung jawab" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="jenjang" id="jenjang"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('jenjang') }}" placeholder="Masukkan jenjang" required>
                        @error('jenjang')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="sub_klasifikasi" id="sub_klasifikasi"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('sub_klasifikasi') }}" placeholder="Masukkan sub klasifikasi" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_sertifikat" id="nomor_sertifikat"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('nomor_sertifikat') }}" placeholder="Masukkan nomor sertifikat">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="jenjang_klasifikasi" id="jenjang_klasifikasi"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('jenjang_klasifikasi') }}" placeholder="Masukkan jenjang klasifikasi">
                    ...
                    <div>
                        ...
                        <input type="text" name="jenjang_kualifikasi" id="jenjang_kualifikasi"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('jenjang_kualifikasi') }}" placeholder="Masukkan jenjang kualifikasi">
