...
@section('title', 'Update Renstra - SIPJAKI')

@section('content')
<div class="p-6">
    <!-- Page Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-2">Renstra</h1>
        <p class="text-gray-600">Kelola informasi renstra SIPJAKI</p>
    </div>

    <!-- Update Form -->
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="p-6">
            <form method="POST" action="{{ route('superadmin.profil.renstra.update') }}">
                @csrf
                @method('PUT')

                <!-- Hidden field for jenis -->
                <input type="hidden" name="jenis" value="renstra">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="deskripsi" id="summernote" class="form-control" rows="10"
                        placeholder="Masukkan renstra...">{{ $renstra->deskripsi ?? '' }}</textarea>
                    @error('deskripsi')
    ...
    <div class="mt-6 bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">Preview Renstra</h3>
