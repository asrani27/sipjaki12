                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_badan_usaha" id="nama_badan_usaha"
                                ...
                                value="{{ old('nama_badan_usaha') }}" placeholder="Masukkan nama badan usaha">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_pimpinan" id="nama_pimpinan"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('nama_pimpinan') }}" placeholder="Masukkan nama pimpinan">
                            @error('nama_pimpinan')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="no_nib" id="no_nib"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('no_nib') }}" placeholder="Masukkan nomor NIB">
                            @error('no_nib')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="no_sbu" id="no_sbu"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('no_sbu') }}" placeholder="Masukkan nomor SBU">
                            @error('no_sbu')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="npwp" id="npwp"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('npwp') }}" placeholder="Masukkan NPWP">
                            @error('npwp')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="instansi" id="instansi"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('instansi') }}" placeholder="Masukkan nama instansi">
                            @error('instansi')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="jenis_usaha" id="jenis_usaha"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('jenis_usaha') }}" placeholder="Masukkan jenis usaha">
                            @error('jenis_usaha')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="sifat_usaha" id="sifat_usaha"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('sifat_usaha') }}" placeholder="Masukkan sifat usaha">
                            @error('sifat_usaha')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="klasifikasi_usaha" id="klasifikasi_usaha"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('klasifikasi_usaha') }}" placeholder="Masukkan klasifikasi usaha">
                        ...
                        <div>
                            ...
                            <input type="text" name="kualifikasi_usaha" id="kualifikasi_usaha"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('kualifikasi_usaha') }}" placeholder="Masukkan kualifikasi usaha">
                        ...
                        <div>
                            ...
                            <input type="text" name="layanan_usaha" id="layanan_usaha"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('layanan_usaha') }}" placeholder="Masukkan layanan usaha">
                            @error('layanan_usaha')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="no_reg_sbu" id="no_reg_sbu"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('no_reg_sbu') }}" placeholder="Masukkan nomor reg SBU">
                            @error('no_reg_sbu')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="status_bpjs" id="status_bpjs"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('status_bpjs') }}" placeholder="Masukkan status BPJS">
                            @error('status_bpjs')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="url" name="url_file_nib" id="url_file_nib"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('url_file_nib') }}" placeholder="https://contoh.com/file-nib.pdf">
                            @error('url_file_nib')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="url" name="url_file_sbu" id="url_file_sbu"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('url_file_sbu') }}" placeholder="https://contoh.com/file-sbu.pdf">
                            @error('url_file_sbu')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="url" name="url_kwitansi" id="url_kwitansi"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                value="{{ old('url_kwitansi') }}" placeholder="https://contoh.com/kwitansi.pdf">
                            @error('url_kwitansi')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
