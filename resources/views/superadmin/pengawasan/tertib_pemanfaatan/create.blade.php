...
@section('title', 'Tambah Tertib Pemanfaatan')

@section('content')
<div class="p-6">
    <!-- Page Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-2">Tambah Data Tertib Pemanfaatan</h1>
        <p class="text-gray-600">Tambahkan data pengawasan tertib pemanfaatan baru</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="p-6">
            <form method="POST" action="{{ route('superadmin.pengawasan.tertib_pemanfaatan.store') }}">
                @csrf
