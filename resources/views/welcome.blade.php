...
<div class="relative mb-12 rounded-2xl overflow-hidden shadow-2xl"
    ...
    <div class="absolute inset-0 opacity-20">
        <div class="absolute inset-0" style="background-image: url('data:image/svg+xml,%3Csvg width=\" 60\"
            ...
            fill-rule=\"evenodd\"%3E%3Cg fill=\"%23ffffff\" fill-opacity=\"0.6\"%3E%3Ccircle cx=\"30\" cy=\"30\"
            r=\"2\"/%3E%3Ccircle cx=\"10\" cy=\"10\" r=\"2\"/%3E%3Ccircle cx=\"50\" cy=\"10\" r=\"2\"/%3E%3Ccircle
            cx=\"10\" cy=\"50\" r=\"2\"/%3E%3Ccircle cx=\"50\" cy=\"50\" r=\"2\"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E');">
        </div>
    </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-transparent"
            ...
            <div class="relative h-96">
                ...
                <div id="slideshow" class="relative h-full">
                    ...
                    <div class="slide absolute inset-0 transition-opacity duration-500 {{ $index == 0 ? '' : 'opacity-0' }}"
                        data-slide="{{ $index }}">
                ...
                <div class="absolute bottom-4 right-4 flex space-x-2">
                    @foreach($slides as $index => $slide)
                    <span
                        class="slide-indicator w-3 h-3 bg-white rounded-full transition-all duration-300 {{ $index == 0 ? 'opacity-100 w-8' : 'opacity-50 w-3' }}"
        ...
        <div class="rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
            ...
            <div class="p-6 text-white">
                <div class="flex items-center mb-4">
                    <div
                        class="w-14 h-14 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center mr-4">
...
<div class="text-center mb-8">
    <h2 class="text-3xl lg:text-4xl font-bold mb-4"
        style="background: linear-gradient(135deg, rgb(51, 95, 185), rgb(242, 143, 7)); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">
        Berita Terbaru
    </h2>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <div
        ...
        <div class="p-6">
            ...
            <a href="#"
                class="inline-flex items-center font-semibold text-blue-600 hover:text-blue-700 transition-colors duration-300">
                Selengkapnya
                <svg class="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                        d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z"
    ...
    <div
        ...
        <div class="p-6">
            <h3 class="text-lg font-bold text-gray-800 mb-2 group-hover:text-green-600 transition-colors duration-300">
                Penelitian</h3>
            <p class="text-gray-600 text-sm mb-4">Pusat penelitian dan pengembangan dengan berbagai publikasi ilmiah
                berkualitas.</p>
            <a href="#"
                class="inline-flex items-center font-semibold text-green-600 hover:text-green-700 transition-colors duration-300">
                Selengkapnya
                <svg class="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                        d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z"
    ...
    <div
        ...
        <div class="p-6">
            <h3 class="text-lg font-bold text-gray-800 mb-2 group-hover:text-purple-600 transition-colors duration-300">
                Teknologi</h3>
            <p class="text-gray-600 text-sm mb-4">Fasilitas teknologi modern untuk mendukung kegiatan akademik dan
                penelitian.</p>
            <a href="#"
                class="inline-flex items-center font-semibold text-purple-600 hover:text-purple-700 transition-colors duration-300">
                Selengkapnya
                <svg class="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                        d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z"
    ...
    <div
        ...
        <div class="p-6">
            <h3 class="text-lg font-bold text-gray-800 mb-2 group-hover:text-orange-600 transition-colors duration-300">
                Kemahasiswaan</h3>
            <p class="text-gray-600 text-sm mb-4">Berbagai kegiatan ekstrakurikuler dan organisasi mahasiswa untuk
                pengembangan diri.</p>
            <a href="#"
                class="inline-flex items-center font-semibold text-orange-600 hover:text-orange-700 transition-colors duration-300">
                Selengkapnya
                <svg class="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                        d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z"
