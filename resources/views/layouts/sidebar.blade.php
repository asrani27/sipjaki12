        ...
        <nav class="flex-1 px-4 py-6 space-y-2 custom-scrollbar overflow-y-auto">
            ...
            <div class="nav-item">
                <button onclick="toggleSubmenu('pelatihan-submenu')"
                    class="flex items-center justify-between w-full px-4 py-2 {{ request()->routeIs('superadmin.pelatihan.*') || request()->routeIs('superadmin.sertifikasi.*') || request()->routeIs('superadmin.bimtek.*') ? 'text-blue-600 bg-blue-50 border-l-4 border-blue-600' : 'text-gray-600' }} rounded-lg hover:bg-gray-50 hover:text-gray-900 transition-colors">
                    <span class="flex items-center space-x-3">
                        <svg class="w-5 h-5 {{ request()->routeIs('superadmin.pelatihan.*') || request()->routeIs('superadmin.sertifikasi.*') || request()->routeIs('superadmin.bimtek.*') ? 'text-blue-600' : 'text-gray-500' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <svg id="pelatihan-arrow"
                        class="w-4 h-4 arrow-icon {{ request()->routeIs('superadmin.pelatihan.*') || request()->routeIs('superadmin.sertifikasi.*') || request()->routeIs('superadmin.bimtek.*') ? 'rotate' : '' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
                <div id="pelatihan-submenu"
                    class="submenu pl-12 space-y-1 {{ request()->routeIs('superadmin.pelatihan.*') || request()->routeIs('superadmin.sertifikasi.*') || request()->routeIs('superadmin.bimtek.*') ? 'open' : '' }}">
                    <a href="{{ route('superadmin.pelatihan.index') }}"
                        class="block px-4 py-2 text-sm {{ request()->routeIs('superadmin.pelatihan.*') ? 'text-blue-600 font-medium' : 'text-gray-600' }} hover:text-gray-900">Pelatihan</a>
                    <a href="{{ route('superadmin.sertifikasi.index') }}"
                        class="block px-4 py-2 text-sm {{ request()->routeIs('superadmin.sertifikasi.*') ? 'text-blue-600 font-medium' : 'text-gray-600' }} hover:text-gray-900">Sertifikasi</a>
                    <a href="{{ route('superadmin.bimtek.index') }}"
                        class="block px-4 py-2 text-sm {{ request()->routeIs('superadmin.bimtek.*') ? 'text-blue-600 font-medium' : 'text-gray-600' }} hover:text-gray-900">Bimtek</a>
                </div>
            </div>
            ...
            <div class="nav-item">
                <button onclick="toggleSubmenu('pengawasan-submenu')"
                    class="flex items-center justify-between w-full px-4 py-2 {{ request()->routeIs('superadmin.pengawasan.*') ? 'text-blue-600 bg-blue-50 border-l-4 border-blue-600' : 'text-gray-600' }} rounded-lg hover:bg-gray-50 hover:text-gray-900 transition-colors">
                    <span class="flex items-center space-x-3">
                        <svg class="w-5 h-5 {{ request()->routeIs('superadmin.pengawasan.*') ? 'text-blue-600' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <svg id="pengawasan-arrow" class="w-4 h-4 arrow-icon {{ request()->routeIs('superadmin.pengawasan.*') ? 'rotate' : '' }}" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
                <div id="pengawasan-submenu" class="submenu pl-12 space-y-1 {{ request()->routeIs('superadmin.pengawasan.*') ? 'open' : '' }}">
                    <a href="{{ route('superadmin.pengawasan.tertib_usaha.index') }}"
                        class="block px-4 py-2 text-sm {{ request()->routeIs('superadmin.pengawasan.tertib_usaha.*') ? 'text-blue-600 font-medium' : 'text-gray-600' }} hover:text-gray-900">Tertib
                        Usaha</a>
            ...
            <a href="{{ route('superadmin.peraturan.index') }}"
                class="flex items-center space-x-3 px-4 py-2 {{ request()->routeIs('superadmin.peraturan.*') ? 'text-blue-600 bg-blue-50 border-l-4 border-blue-600' : 'text-gray-600' }} rounded-lg hover:bg-gray-50 hover:text-gray-900 transition-colors">
                <svg class="w-5 h-5 {{ request()->routeIs('superadmin.peraturan.*') ? 'text-blue-600' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <span>Peraturan</span>
